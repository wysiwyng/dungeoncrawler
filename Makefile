...
CFLAGS=-I$(INCLUDEDIR) -I$(POLYDIR)Core/Dependencies/include -I$(POLYDIR)Core/Dependencies/include/AL -I$(POLYDIR)Core/include -I$(POLYDIR)Modules/include -I$(POLYDIR)Modules/Dependencies/include -I$(POLYDIR)Modules/Dependencies/include/bullet
...
SRC=$(SRCDIR)linuxMain.cpp $(SRCDIR)dungeonCore.cpp
default:
	mkdir -p $(BUILDDIR)
	$(CC) $(CFLAGS) $(SRC) -o $(BUILDDIR)$(OUTFILE) $(LDFLAGS)
